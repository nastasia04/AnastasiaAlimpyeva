...
public class UtilsFunctions {
    ...
    public List<String> getTextFromListOfWebElements(ElementsCollection collection) {
        return collection.stream().map(WebElement::getText).collect(Collectors.toList());
    }
