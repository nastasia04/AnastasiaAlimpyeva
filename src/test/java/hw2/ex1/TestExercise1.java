...
public class TestExercise1 extends BaseClass {
    ...
    private static final String mainHeader = "EPAM framework Wishes…";
    private static final String mainHeaderText = "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod " +
    ...
    public void TestForExercise1() {
        ...
        step.checkItemsAreDisplayedAndHaveTheCorrectText("//ul[contains(@class, 'm-l8')]/li",
        ...
        step.checkItemsAreDisplayedAndHaveTheCorrectText("//span[@class='benefit-txt']",
